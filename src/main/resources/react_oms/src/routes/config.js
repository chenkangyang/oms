// auth: value 字段的设置: 404那些permissions中不包含value的用户
export default {
    menus: [ // 菜单相关路由
        // { key: '/app/dashboard/index', title: '首页', icon: 'mobile', component: 'Dashboard'},
        { key: '/app/index', title: '首页', icon: 'mobile', component: 'BasicBoard'},
        // {
        ...
        // },
        {
            ...
            subs: [
                { key: '/app/table/MerchantGoodsTable', title: '商家商品表格', component: 'MerchantGoodsTable', auth: "auth/admin"},
                { key: '/app/table/MerchantOrdersTable', title: '商家订单表格', component: 'MerchantOrdersTable', auth: "auth/admin"},
                { key: '/app/table/UserOrdersTable', title: '用户订单表格', component: 'UserOrdersTable', auth: "auth/visitor"},
            ],
        },
        // {
        ...
        //         { key: '/app/auth/routerEnter', title: '路由拦截', component: 'RouterEnter' },
        //     ],
        // },
        // {
